FROM ubuntu:latest
LABEL maintainer="Ali Bungker <alibungker@gmail.com>"

RUN apt-get update && apt-get install -y python-pip python-dev build-essential mysql-server libmysqlclient-dev nano sudo
# Install uWSGI
...
#install python dan add on lainnya
